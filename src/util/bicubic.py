...
def blending_function_bicubic(s:float, t: float, gb: List[List[float]]) -> float:
    ...
    blending = matrix_multiplication(param_s, BEZIER_MATRIX)
    blending = matrix_multiplication(blending, gb)
    blending = matrix_multiplication(blending, BEZIER_MATRIX)
    blending = matrix_multiplication(blending, param_t)
