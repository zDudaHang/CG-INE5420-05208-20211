...
# ========== UPDATE WINDOW VALUES
    ...
    def gupdate_window_values(self, window_obj_file: List[List[float]]):
...
# ====================== UTILITIES:
    ...
    def add_new_object(self, name: str, coordinates: list, type: GraphicObjectEnum, color: QColor, is_filled: bool, is_clipped: bool):
